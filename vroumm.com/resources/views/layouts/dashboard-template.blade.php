    ...
    <div class="container side" >
        ...
        <div class="wrapper">
            ...
            <li class="@yield('mycar')">
                <a href="{{ route('mycar') }}"> {{ __('My Car') }}</a>
            </li>

            <li class="@yield('offeredride')">
                <a href="{{ route('offered-rides') }}">{{ __('Offered Rides') }}</a>
            </li>
        ...
        <ul class="list-unstyled CTAs">
            <li>
                <a href="{{ route('logout') }}"  onclick="event.preventDefault();  document.getElementById('logout-form').submit();" class="download">{{ __('Logout') }}</a>
            </li>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a  class=" nav-link" href="{{ route('offer-ride') }}">{{ __('Offer a ride') }}</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('find-ride') }}">{{ __('Find a ride') }}</a>
                        </li>
