            ...
            <div class="row align-items-baseline justify-content-between">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-footer-widget mb-80">
                        <!-- Footer Logo -->
                        <a href="#" class="footer-logo"><img src={{asset("img/logo3.png")}} alt="vroumm logo"></a>
                ...
                <div class="col-12 col-sm-4 col-lg-2">
                    <div class="single-footer-widget mb-80">
                        ...
                        <ul class="footer-nav">
                            ...
                            {{ __('Contact') }} </a></li>
                            <li><a href="{{route('terms')}}"><i class="fa fa-caret-right" aria-hidden="true"></i>
                            {{ __('Terms and Conditions') }} </a></li>
                            <li><a href="{{route('faqs')}}"><i class="fa fa-caret-right" aria-hidden="true"></i>
                            {{__('FAQs') }} </a></li>
                        </ul>
                    </div>
                </div>
